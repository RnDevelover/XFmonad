...
myApplications = [ ("Pluma", "pluma", "Pluma text editor")
                 ...
                 , ("Free slot 3", "echo 3", "Free slot 3")
                 , ("Gimp", "gimp", "GNU image editing program")
                 , ("Suspend", "systemctl suspend", "Suspend the computer")
                 , ("LibreOffice Impress", "loimpress", "For making presentations")
                 , ("Free slot 4", "echo 4", "Free slot 4")
                 , ("Web apps", "~/.xmonad/scripts/myApps.sh", "Start the favourite Web apps")
